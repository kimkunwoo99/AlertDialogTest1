    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String[] foodItems = {"치킨","햄버거","피자"};
                final int[] imgRes = {R.drawable.chicken, R.drawable.hamburger,R.drawable.pizza};
                AlertDialog.Builder dlg = new AlertDialog.Builder(MainActivity.this);
                dlg.setTitle("인공지능소프트웨어 공지사항");
...
//                dlg.setMessage("우리과 학생이 사탕이라 한다고 친절하게 양해를 구하면 됩니다.");
                dlg.setIcon(R.drawable.chrome);
